                        ...
                        <div class="wdm_inner_div">
                            <div class="wdm_chat_app">
                                ...
                                <div class="wdm_reply_box">
                                    <div class="reply_box">
                                        <form id="response_form_submit" method="post">
                                            ...
                                            <input type="hidden" name="action" value="create_response_admin">

                                            <button class="course-button medium-btn" name="response_post" type="submit"><i class="fa fa-arrow-right"></i></button>
                                        </form>
                                    </div>
                                </div>
